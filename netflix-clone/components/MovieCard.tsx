    ...
    return (
        <div className="group bg-zinc-900 col-span relative h-[12vw]">
            ...
            <div className=" opacity-0 absolute top-0 transition duration-200 z-10 invisible sm:visible delay-300 w-full scale-0 group-hover:scale-110 group-hover:-translate-y-[6vw] group-hover:translate-x-[2vw] group-hover:opacity-100">
                <img className="cursor-pointer object-cover transition duration shadow-xl rounded-t-md w-full h-[12vw]" src={data.thumbnailurl} alt="Thumnail" />
                <div className="z-10 bg-zinc-800 p-2 la:p-4 absolute w-fulL transition shadow-md rounded-b-md">
                    <div className="flex fled-row items-center gap-3">
